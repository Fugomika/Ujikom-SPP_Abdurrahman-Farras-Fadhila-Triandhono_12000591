        ...
        $.ajax({
            ...
            success: function(data){
                ...
                jQuery.each(data["payed"],function(i,val){
                    $('#rspp').append('<div class="row justify-content-center align-items-center g-2"> <div class="col">'+val["month_name"]+' - '+val["year"]+'</div> <div class="col">'+val["treasurer"]+'</div> <div class="col">'+val["created_at"].slice(0,10)+'</div> <div class="col">'+data["payed"].length+'</div> <div class="col">'+val["price"]+'</div> </div>');
                });
            }
        });
    })
